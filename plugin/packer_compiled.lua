...
_G.packer_plugins = {
  ["Comment.nvim"] = {
    after_files = { "/home/taotao/.local/share/nvim/site/pack/packer/opt/Comment.nvim/after/plugin/Comment.lua" },
  ...
  LuaSnip = {
    ...
    loaded = false,
    needs_bufread = true,
    path = "/home/taotao/.local/share/nvim/site/pack/packer/opt/LuaSnip",
  ...
  base46 = {
    ...
    loaded = true,
    only_config = true,
    path = "/home/taotao/.local/share/nvim/site/pack/packer/start/base46",
    url = "https://hub.fastgit.xyz/NvChad/base46"
  },
  ["cmp-buffer"] = {
    after = { "cmp-path" },
    after_files = { "/home/taotao/.local/share/nvim/site/pack/packer/opt/cmp-buffer/after/plugin/cmp_buffer.lua" },
    load_after = {
      ["cmp-nvim-lsp"] = true
    },
    loaded = false,
    needs_bufread = false,
    path = "/home/taotao/.local/share/nvim/site/pack/packer/opt/cmp-buffer",
    url = "https://hub.fastgit.xyz/hrsh7th/cmp-buffer"
  },
  ["cmp-nvim-lsp"] = {
    after = { "cmp-buffer" },
    after_files = { "/home/taotao/.local/share/nvim/site/pack/packer/opt/cmp-nvim-lsp/after/plugin/cmp_nvim_lsp.lua" },
    load_after = {
      ["cmp-nvim-lua"] = true
    },
    loaded = false,
    needs_bufread = false,
    path = "/home/taotao/.local/share/nvim/site/pack/packer/opt/cmp-nvim-lsp",
    url = "https://hub.fastgit.xyz/hrsh7th/cmp-nvim-lsp"
  },
  ["cmp-nvim-lua"] = {
    after = { "cmp-nvim-lsp" },
    after_files = { "/home/taotao/.local/share/nvim/site/pack/packer/opt/cmp-nvim-lua/after/plugin/cmp_nvim_lua.lua" },
    load_after = {
      cmp_luasnip = true
    },
    loaded = false,
    needs_bufread = false,
    path = "/home/taotao/.local/share/nvim/site/pack/packer/opt/cmp-nvim-lua",
    url = "https://hub.fastgit.xyz/hrsh7th/cmp-nvim-lua"
  },
  ["cmp-path"] = {
    after_files = { "/home/taotao/.local/share/nvim/site/pack/packer/opt/cmp-path/after/plugin/cmp_path.lua" },
    load_after = {
      ["cmp-buffer"] = true
    },
    loaded = false,
    needs_bufread = false,
    path = "/home/taotao/.local/share/nvim/site/pack/packer/opt/cmp-path",
    url = "https://hub.fastgit.xyz/hrsh7th/cmp-path"
  },
  cmp_luasnip = {
    after = { "cmp-nvim-lua" },
    after_files = { "/home/taotao/.local/share/nvim/site/pack/packer/opt/cmp_luasnip/after/plugin/cmp_luasnip.lua" },
    load_after = {
      LuaSnip = true
    },
    loaded = false,
    needs_bufread = false,
    path = "/home/taotao/.local/share/nvim/site/pack/packer/opt/cmp_luasnip",
  ...
  extensions = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/taotao/.local/share/nvim/site/pack/packer/opt/extensions",
    url = "https://hub.fastgit.xyz/NvChad/extensions"
  },
  ["friendly-snippets"] = {
    after = { "nvim-cmp" },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
    path = "/home/taotao/.local/share/nvim/site/pack/packer/opt/friendly-snippets",
  ...
  ["indent-blankline.nvim"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/home/taotao/.local/share/nvim/site/pack/packer/opt/indent-blankline.nvim",
  ...
  ["mason.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/taotao/.local/share/nvim/site/pack/packer/opt/mason.nvim",
    url = "https://hub.fastgit.xyz/williamboman/mason.nvim"
  },
  ["nvim-autopairs"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/home/taotao/.local/share/nvim/site/pack/packer/opt/nvim-autopairs",
  ...
  ["nvim-cmp"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/home/taotao/.local/share/nvim/site/pack/packer/opt/nvim-cmp",
  ...
  ["nvim-colorizer.lua"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/home/taotao/.local/share/nvim/site/pack/packer/opt/nvim-colorizer.lua",
  ...
  ["nvim-lspconfig"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/home/taotao/.local/share/nvim/site/pack/packer/opt/nvim-lspconfig",
  ...
  ["nvim-tree.lua"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/taotao/.local/share/nvim/site/pack/packer/opt/nvim-tree.lua",
  ...
  ["nvim-web-devicons"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/taotao/.local/share/nvim/site/pack/packer/opt/nvim-web-devicons",
  ...
  nvterm = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/taotao/.local/share/nvim/site/pack/packer/opt/nvterm",
    url = "https://hub.fastgit.xyz/NvChad/nvterm"
  },
  ["packer.nvim"] = {
    loaded = true,
  ...
  ui = {
    ...
    loaded = true,
    needs_bufread = false,
    path = "/home/taotao/.local/share/nvim/site/pack/packer/opt/ui",
    url = "https://hub.fastgit.xyz/NvChad/ui"
  },
  ["which-key.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/taotao/.local/share/nvim/site/pack/packer/opt/which-key.nvim",
